...
namespace Anonimizador___API.Infrastructure.Data
{
    ...
    public class OracleDynamicParameters : SqlMapper.IDynamicParameters
    {
        ...
        public void Add(string name, object? value = null, OracleDbType dbType = OracleDbType.NVarchar2, ParameterDirection direction = ParameterDirection.Input, int size = 0)
        {
        ...
        /// <summary>
        /// Agrega un parámetro de entrada (Input). Forma abreviada del método Add.
        ...
        public void AddInput(string name, object? value, OracleDbType dbType = OracleDbType.NVarchar2)
        ...
        /// se declara un cursor OUT y Dapper lo lee automáticamente.
        /// </summary>
        ...
        /// Maneja la conversión desde tipos nativos de Oracle (OracleDecimal, OracleString)
        /// hacia tipos .NET estándar, ya que Oracle no retorna tipos primitivos directamente.
        /// </summary>
        ...
        public T Get<T>(string name)
        {
            ...
            // Oracle retorna tipos propios (OracleDecimal, OracleString, etc.)
            // en lugar de tipos .NET — hay que extraer el valor interno primero
            if (value is Oracle.ManagedDataAccess.Types.OracleDecimal oracleDecimal)
                value = (int)oracleDecimal.Value;
            else if (value is Oracle.ManagedDataAccess.Types.OracleString oracleString)
